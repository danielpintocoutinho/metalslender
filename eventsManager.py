...
class EventManager(DirectObject):
	...
	def __init__(self, base, player, itemList):
		...
		self.point0 = scene_obj.SceneObj("point0", "assets/models/sphere", base.render, self.vision, 1)
		self.point1 = scene_obj.SceneObj("point1", "assets/models/sphere", base.render, Vec3(100,25,10), 1)
		self.point2 = scene_obj.SceneObj("point2", "assets/models/sphere", base.render, Vec3(160,20,15), 1)
		self.point3 = scene_obj.SceneObj("point3", "assets/models/sphere", base.render, Vec3(280,70,15), 1)
